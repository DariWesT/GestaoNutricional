        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>Gestão Nutricional</strong> Registre-se</h1>
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top">
                        <div class="form-top-left">
                            <h3>Preencha os dados para registrar-se</h3>
                    ...
                    <div class="form-bottom">
                        <form role="form"  method="post" class="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="form-username" placeholder="Nome..." class="form-username form-control" id="form-username" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"   name="form-contact" placeholder="NIF..." class="form-username form-control" id="form-contact" required>
                            </div>
                            <div class="form-group">
